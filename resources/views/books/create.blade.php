    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-amber-900 font-serif">Agregar Nuevo Libro</h1>
                    <p class="text-amber-700 mt-2">Completa la información del libro</p>
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('books.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                              class="w-full border border-amber-300 rounded-lg px-3 py-3 bg-white/50 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                              placeholder="Descripción del libro, sinopsis, etc...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <!-- Cover Image -->
                <div>
                    <label for="cover_image" class="block text-sm font-medium text-amber-800 mb-2">Imagen de Portada</label>
